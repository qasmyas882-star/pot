...
-- 3) البوت يستخدم الآن Supabase REST API مع مفتاح anon (لا يحتاج psycopg2 ولا SUPABASE_DB_URL).
--    تُضبط بيانات الاتصال عبر متغيرات البيئة: SUPABASE_URL و SUPABASE_ANON_KEY.
